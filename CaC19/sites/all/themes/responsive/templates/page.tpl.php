...
<div id="copyright" class="container">
 <div class="credit"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?>. <?php print t('Theme developed by'); ?> <a href="http://www.devsaran.com" target="_blank">Devsaran</a>.</div>
  <div class="clear"></div>
</div>
